...
struct unit_test {
    ...
    static void multi_change_buffer(std::shared_ptr<recycle_memory<int>> recycler, int max, int data);
    ...
    static void multi_change_buffer_threaded(std::shared_ptr<recycle_memory<int>> recycler);
    ...
    static void wait_multi_take_from_fill_threaded(std::shared_ptr<recycle_memory<int>> recycler, int max);
    static void watcher_check_reference_counts(std::shared_ptr<recycle_memory<int>> recycler);
